...
import app.talat.notepad.Adapter.NotesAdapter;
import app.talat.notepad.callbacks.MainActionModeCallback;
import app.talat.notepad.callbacks.NoteEventListener;
import app.talat.notepad.db.NotesDB;
import app.talat.notepad.db.NotesDao;
import app.talat.notepad.model.Note;
import app.talat.notepad.utils.NoteUtils;
...
import static app.talat.notepad.EditNoteActivity.NOTE_EXTRA_Key;
